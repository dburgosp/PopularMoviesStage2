package com.example.android.popularmoviesstage2.dialogpreferences;
 ...
 */
public class MoviesListDialogPreference extends DialogPreference {

    public MoviesListDialogPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
