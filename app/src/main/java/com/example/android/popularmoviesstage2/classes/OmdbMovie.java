...
/**
 * Public class for managing some info from OmdbMovie API (http://www.omdbapi.com).
 */
public class OmdbMovie implements Parcelable {
     ...
     */
    OmdbMovie(String rated, String awards, String dvd, Double imdb_vote_average,
    ...
    public static final Parcelable.Creator<OmdbMovie> CREATOR = new Parcelable.Creator<OmdbMovie>() {
        @Override
        public OmdbMovie createFromParcel(Parcel source) {
            return new OmdbMovie(source);
        }

        @Override
        public OmdbMovie[] newArray(int size) {
            return new OmdbMovie[size];
        }
    };
}
