...
public class OLD_MainActivity extends AppCompatActivity implements
        NavigationView.OnNavigationItemSelectedListener {
    private static final String TAG = OLD_MainActivity.class.getSimpleName();
    ...
    private View.OnClickListener onClickMoviesListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(OLD_MainActivity.this, MoviesActivity.class);
            intent.putExtra("sort", sort);

            // Start MoviesActivity with animation.
            Bundle option = ActivityOptions.makeSceneTransitionAnimation(OLD_MainActivity.this)
                    .toBundle();
                        ...
                        if (allowClicks) {
                            ...
                            ActivityOptionsCompat options =
                                    ActivityOptionsCompat.makeSceneTransitionAnimation(
                                            OLD_MainActivity.this, clickedView,
                            ...
                            // care for any result.
                            Intent intent = new Intent(OLD_MainActivity.this,
    ...
    void setUpcomingMovies() {
        if (upcomingMovies != null && upcomingMovies.size() > 0) {
            ...
            if (backdropPath != null && !backdropPath.equals("") && !backdropPath.isEmpty()) {
                ...
                Picasso.with(OLD_MainActivity.this)
                        .load(backdropPath)
            ...
            final DisplayUtils displayUtils = new DisplayUtils(OLD_MainActivity.this);
...
/*            TextViewUtils.setTintedCompoundDrawable(OLD_MainActivity.this,
            ...
            upcomingMoviesMostPopularLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(OLD_MainActivity.this, MovieDetailsActivity.class);
    ...
    private class MainActivityMoviesList implements LoaderManager.LoaderCallbacks<ArrayList<TmdbMovie>> {
        ...
        public Loader<ArrayList<TmdbMovie>> onCreateLoader(int id, Bundle args) {
            ...
            if (NetworkUtils.isConnected(OLD_MainActivity.this)) {
                ...
                switch (id) {
                    case NetworkUtils.TMDB_NOW_PLAYING_MOVIES_LOADER_ID:
                        return new TmdbMoviesAsyncTaskLoader(OLD_MainActivity.this,
