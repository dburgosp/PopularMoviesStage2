 ...
 */
public class TmdbCrew implements Parcelable {
     ...
     *                     person.
     */
    public TmdbCrew(int id, String job, String name, String profile_path) {
        this.credit_id = "";
        this.department = "";
        this.gender = 0;
        this.id = id;
     ...
     *                     person.
     */
    public TmdbCrew(String credit_id, String department, int gender, int id, String job, String name,
                    String profile_path) {
    ...
    public static final Parcelable.Creator<TmdbCrew> CREATOR = new Parcelable.Creator<TmdbCrew>() {
        @Override
        public TmdbCrew createFromParcel(Parcel source) {
            return new TmdbCrew(source);
        }

        @Override
        public TmdbCrew[] newArray(int size) {
            return new TmdbCrew[size];
        }
    };
}
