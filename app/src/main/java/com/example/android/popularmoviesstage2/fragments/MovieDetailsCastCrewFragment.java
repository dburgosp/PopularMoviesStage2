...
public class MovieDetailsCastCrewFragment extends Fragment
    ...
    @BindView(R.id.cast_crew_no_result_image_view)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_movie_details_cast_crew, container,
                false);
        ...
        // separate thread.
        getLoaderManager().initLoader(NetworkUtils.TMDB_CAST_CREW_LOADER_ID, null,
                this);
    ...
    public Loader<Object> onCreateLoader(int id, Bundle args) {
        if (NetworkUtils.isConnected(getContext())) {
            ...
            return new GenericAsyncTaskLoader(getContext(), movieId,
                    GenericAsyncTaskLoader.ASYNC_TASK_LOADER_TYPE_TMDB_CAST_CREW);
        } else {
    ...
    public void onLoadFinished(Loader<Object> loader, Object data) {
        ...
        if (NetworkUtils.isConnected(getContext())) {
            ...
            // adapters' data sets.
            ArrayList<TmdbCast> castArrayList = ((TmdbCastCrew) data).getCast();
            ArrayList<TmdbCrew> crewArrayList = ((TmdbCastCrew) data).getCrew();
    ...
    void setRecyclerViews() {
        ...
        CastAdapter.OnItemClickListener castListener = new CastAdapter.OnItemClickListener() {
            ...
            public void onItemClick(TmdbCast cast) {
                ...
                TmdbPerson person = new TmdbPerson(cast.getId(), cast.getName(),
        ...
        CrewAdapter.OnItemClickListener crewListener = new CrewAdapter.OnItemClickListener() {
            ...
            public void onItemClick(TmdbCrew crew) {
                ...
                Intent intent = new Intent(getContext(), PersonDetailsActivity.class);
                TmdbPerson person = new TmdbPerson(crew.getId(), crew.getName(),
    ...
    /**
     * Helper method to set the cast section.
     *
     * @param castArrayList is the list of cast members.
     */
    private void setCast(ArrayList<TmdbCast> castArrayList) {
        if (castArrayList != null && castArrayList.size() > 0) {
    ...
    /**
     * Helper method to set the crew section.
     *
     * @param crewArrayList is the list of crew members.
     */
    private void setCrew(ArrayList<TmdbCrew> crewArrayList) {
     ...
     * given department.
     */
    private ArrayList<TmdbCrew> getFilteredCrewArrayList(ArrayList<TmdbCrew> crewArrayList,
                                                         String department) {
     ...
     */
    private boolean setCrewTextView(ArrayList<TmdbCrew> crewArrayList, TextView textView,
                                    String title) {
        if (crewArrayList.size() > 0) {
            String text = "";
            String color =
                    String.format("%X", getResources().getColor(R.color.colorDarkGrey)).substring(2);
